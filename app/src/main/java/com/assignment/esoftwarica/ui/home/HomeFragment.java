...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Students students = new Students("sahan", "banasthali", "Male", "18",R.drawable.noimg);
        studentsList = students.getStudentsList();
        if (studentsList.isEmpty()){
            studentsList.add(new Students("sahan dhakal", "banasthali", "Male", "18", R.drawable.maleimg));
            studentsList.add(new Students("sahina dhakal", "banasthali", "Female", "16", R.drawable.femaleimg));
